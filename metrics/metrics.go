...
//
// Internal implementaion uses a default logger from github.com/SamsungSLAV/slav/logger package
// for logging errors and notiications.
package metrics
...
type Gauge interface {
	...
	Dec()
	// Set makes an explicit change to gauge value.
	Set(value float64)
}
...
type Metrics interface {
	...
	// It case of success it returns a Gauge interface instance for controlling
	// created metric.
