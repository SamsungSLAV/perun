...
Please notice that every profile and type requires separate ProfileConfiguration
	...
	{"profiles": [
			{"server": "download.tizen.org", "type": "snapshot", "profile": "unified", "period": "20s"},
			{"server": "download.tizen.org", "type": "snapshot", "profile": "unified-4.0", "period": "91s"},
			{"server": "download.tizen.org", "type": "snapshot", "profile": "common-3.0", "period": "92s"},
			{"server": "download.tizen.org", "type": "prerelease", "profile": "unified", "period": "15s"},
			{"server": "download.tizen.org", "type": "prerelease", "profile": "unified-4.0", "period": "64s"},
			{"server": "download.tizen.org", "type": "prerelease", "profile": "common-3.0", "period": "65s"}
		],
		"tasksqueue": 5000,
		"workers": 70
	}
